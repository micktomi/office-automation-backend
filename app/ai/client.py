...
class AIClient:
    ...
    async def chat_response(self, user_message: str, action_result: str | None = None) -> str:
        ...
        prompt = (
            "Είσαι ο έξυπνος βοηθός ενός ασφαλιστικού γραφείου. "
            "Μπορείς να εκτελέσεις συγκεκριμένες ενέργειες (σου ζητάει ο χρήστης και εσύ εκτελείς από πίσω): "
            ...
            "5. Να γράψεις, να ολοκληρώσεις και να δείξεις λίστες με tasks/εργασίες.\n"
            "6. Να δεις το ημερολόγιο (Calendar) και να προσθέσεις ραντεβού.\n"
            "7. Να στείλεις μηνύματα στο κινητό μέσω WhatsApp.\n\n"
